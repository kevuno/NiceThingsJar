...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{URL::secure_asset('css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Material Design Bootstrap -->
    <link href="{{URL::secure_asset('css/mdb.min.css')}}" rel="stylesheet">

    <!-- Personalized styles -->
    <link href="{{URL::secure_asset('css/style.css')}}" rel="stylesheet">
...
<body>
    ...
    <!-- JQuery -->
    <script src="{{URL::secure_asset('js/jquery-3.1.1.min.js')}}"></script>
    <!-- Tooltips -->
    <script src="{{URL::secure_asset('js/tether.min.js')}}"></script>
    <!-- Bootstrap core JavaScript -->
    <script src="{{URL::secure_asset('js/bootstrap.min.js')}}"></script>
    <!-- Cool animations -->
    <script src="{{URL::secure_asset('js/wow.js')}}"></script>
    <!-- MDB JavaScript -->
    <script src="{{URL::secure_asset('js/mdb.js')}}"></script>
    <!-- Custom JavaScript -->
