                    ...
                    <div class="row" id="home">
                        ...
                        <div class="col-lg-6">
                            <div class="description">
                                ...
                                <a class="btn btn-outline-white btn-lg wow fadeInRight" data-wow-delay="0.7s">Download <i class="fa fa-android left right" aria-hidden="true"></i>
                        ...
                        <div class="col-lg-4 offset-lg-1 flex-center">
                            <!--Form-->
                            <img src="https://mdbootstrap.com/images/mockups/header-iphone.png" alt="" class="img-fluid wow fadeInRight" id="app-mockup">
                            <!--/.Form-->
                        </div>
                        <!--/Second column-->
                    </div>
    ...
    <main>
        <div class="container">
            ...
            <section class="section" id="examples-of-use">
                ...
                <div class="row">
                    <!--First column-->
                    <div class="col-md-12 mb-r wow fadeIn" data-wow-delay="0.4s">
                        <!--Card-->
                        <div class="card-overlay" style="background-image: url('https://mdbootstrap.com/img/Photos/Exposure/Dark/img%20(1).jpg')">
                            <!--Content-->
                    ...
                    <!--/First column-->
                    <!--Second column-->
                    <div class="col-md-6 mb-r wow fadeIn" data-wow-delay="0.4s">
                        <!--Card-->
                        <div class="card-overlay" style="background-image: url('https://mdbootstrap.com/img/Photos/Exposure/Dark/img%20(2).jpg')">
                            <!--Content-->
                            <div class="white-text text-center">
                                <div class="card-block">
                    ...
                    <div class="col-md-6 mb-r wow fadeIn" data-wow-delay="0.4s">
                        <!--Card-->
                        <div class="card-overlay" style="background-image: url('https://mdbootstrap.com/img/Photos/Exposure/Dark/img%20(3).jpg')">
                            <!--Content-->
                            <div class="white-text text-center">
                                <div class="card-block">
                    ...
                    <div class="col-lg-4 col-md-6 mb-r wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <div class="pricing-card naked-card">
                            ...
                            <div class="card-block">
                                ...
                                <a class="btn btn-mdb btn-lg"> Buy now</a>
                            </div>
                        </div>
                        <!--/.Card-->
                    </div>
                        ...
                        <div class="card-wrapper">
                            <div id="card-1" class="card-rotating effect__click">
                                ...
                                <div class="face front">
                                    ...
                                    <!-- Image-->
                                    <div class="card-up">
                                        <img src="https://mdbootstrap.com/images/regular/nature/img%20(55).jpg">
                                    </div>
                                    <!--Avatar-->
                                    <div class="avatar"><img src="https://mdbootstrap.com/images/avatars/img%20(2).jpg" class="rounded-circle img-responsive">
                                    </div>
                                    <!--Content-->
                                    <div class="card-block">
                                        <h4>Maria Kate</h4>
                        ...
                        <div class="card-wrapper">
                            <div id="card-2" class="card-rotating effect__click">
                                ...
                                <div class="face front">
                                    ...
                                    <!-- Image-->
                                    <div class="card-up">
                                        <img src="https://mdbootstrap.com/images/regular/nature/img%20(64).jpg">
                                    </div>
                                    <!--Avatar-->
                                    <div class="avatar"><img src="https://mdbootstrap.com/images/avatars/img%20(1).jpg" class="rounded-circle img-responsive">
                                    </div>
                                    <!--Content-->
                                    <div class="card-block">
                                        <h4>Anna Deynah</h4>
                        ...
                        <div class="card-wrapper">
                            <div id="card-3" class="card-rotating effect__click">
                                ...
                                <div class="face front">
                                    ...
                                    <!-- Image-->
                                    <div class="card-up">
                                        <img src="https://mdbootstrap.com/images/regular/nature/img%20(68).jpg">
                                    </div>
                                    <!--Avatar-->
                                    <div class="avatar"><img src="https://mdbootstrap.com/images/avatars/img%20(5).jpg" class="rounded-circle img-responsive">
                                    </div>
                                    <!--Content-->
                                    <div class="card-block">
                                        <h4>Sarah Melyah</h4>
            ...
            <section class="section mb-4" id="contact">
                ...
                <div class="row">
                    ...
                    <!--Second column-->
                    <div class="col-md-7 wow fadeIn" data-wow-delay="0.4s">
